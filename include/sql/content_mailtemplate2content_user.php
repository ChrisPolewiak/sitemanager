 ...
 * @version		5.0.0
*/
function content_mailtemplate2content_user_delete( $content_mailtemplate__id, $content_user__id ) {
 ...
 * @version		5.0.0
*/
function content_mailtemplate2content_user_get( $content_mailtemplate__id, $content_user__id ) {
