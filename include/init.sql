...
CREATE TABLE IF NOT EXISTS `%prefix%_core_updated` (
  `core_updated__id` char(36) NOT NULL,
  `core_updated__tableid` char(36) NOT NULL,
  `core_updated__table` varchar(255) DEFAULT NULL,
  `core_updated__olddata` blob,
  `record_create_date` int(11) DEFAULT NULL,
  `record_create_id` char(36) DEFAULT NULL,
  PRIMARY KEY (`core_updated__id`),
  KEY `core_updated__tableid` (`core_updated__tableid`),
  KEY `core_updated__table` (`core_updated__table`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `%prefix%_core_session` (
  ...
  `core_session__data` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci,
