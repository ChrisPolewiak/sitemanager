					...
					<form action="<?=$page?>" method=post enctype="multipart/form-data" id="sm-form">
						...
						<fieldset class="no-legend">
							<?=sm_inputfield(array(
								...
								"help"=>"",
								"id"=>"dane_core_deleted__table",
								"name"=>"dane[core_deleted__table]",
								"value"=>$dane["core_deleted__table"],
								"size"=>"block-level",
								"disabled"=>1,
								"validation"=>0,
								"prepend"=>0,
							...
							<?=sm_inputfield(array(
								...
								"help"=>"",
								"id"=>"dane_core_deleted__tableid",
								"name"=>"dane[core_deleted__tableid]",
								"value"=>$dane["core_deleted__tableid"],
								"size"=>"block-level",
								"disabled"=>1,
								"validation"=>0,
								"prepend"=>0,
...
?>
							<?=sm_inputfield(array(
								...
								"help"=>"",
								"id"=>"dane_core_deleted__tableid",
								"name"=>"dane[core_deleted__olddata]",
								"value"=>$olddata,
								"size"=>"block-level",
								"disabled"=>1,
								"validation"=>0,
